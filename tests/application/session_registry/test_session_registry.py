...
class TestSessionRegistry:
    ...
    def test_add_session_registers_and_can_be_retrieved(
        ...
        assert (
            session_registry.get(fake_session_context.id).id == fake_session_context.id
        )
        assert (
            session_registry.get(fake_session_context.id).session
            == fake_session_context.session
        )
